...
class ResBlockDiscriminator(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1, sn=True):
...
class Discriminator(nn.Module):
    def __init__(self, DISC_SIZE=128, sn=True):
        ...
        self.model = nn.Sequential(
                FirstResBlockDiscriminator(channels, DISC_SIZE, stride=2, sn=sn),
